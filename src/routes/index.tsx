...
const testimonials = [
  ...
  },
  {
    ...
    role: 'UMS Student',
    rating: 5,
    text: 'By the way, I already ate 3 just now. So soft 💕 I really like it, and there’s a lot of milk too 😍😍 So delicious, definitely can repeat buy. My friends also ate it and said it’s soft hehe 😋',
    initials: 'A',
    color: '#7C4A1E',
  },
  {
    ...
    role: 'UMS Student',
    rating: 5,
    text: 'Farah, I have already eaten your, it was really delicious.',
    initials: 'SN',
    color: '#5C3317',
  },
  {
    ...
    role: 'UMS Student',
    rating: 5,
    text: 'So yummy 😋 even though it was already cold 🤩 I was a bit late picking it up from the laundry. But it’s all gone already, Farah. Eating it during high tea was perfect.',
    initials: 'A',
    color: '#C9944A',
  },
  {
    ...
    role: 'UMS Student',
    rating: 5,
    text: 'The milky donuts are delicious, guys😋. you should buy it',
    initials: 'D',
    color: '#A86540',
  },
  {
    ...
    role: 'UMS Student',
    rating: 5,
    text: 'Wiii hiii!! just want to say that the donut is seriously so delicious!! So soft?? My housemates said it’s good too! Next time I want to buy again during the expo!!',
    initials: 'KA',
    color: '#3D1F08',
  },
]
...
const features = [
  ...
  },
  {
    ...
    title: 'Fresh Daily',
    desc: 'We deliver in a small batch on weekend — your donut is never more than hours old.',
  },
  {
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
