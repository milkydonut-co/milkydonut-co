...
const teamMembers = [
  {
    ...
    color: '#7C4A1E',
    bgColor: '#E8D5B5',
    imageUrl: 'https://i.imgur.com/U3xo2JZ.jpeg',
  ...
  },
  {
    ...
    canva: 'https://canva.link/gdsq33z4gdk8yht',
    initials: 'SS',
    color: '#C4956A',
    bgColor: '#F2E8D5',
  ...
  },
  {
    ...
    color: '#3D1F08',
    bgColor: '#C4956A',
    imageUrl: 'https://i.imgur.com/pZlemGe.jpeg',
  ...
  },
  {
    ...
    color: '#7C4A1E',
    bgColor: '#E8D5B5',
    imageUrl: 'https://i.imgur.com/h77vR4X.jpeg',
  ...
  },
  {
    ...
    color: '#5C3317',
    bgColor: '#D4BC95',
    imageUrl: 'https://i.imgur.com/NVhhB8S.jpeg',
  ...
  },
  {
    ...
    color: '#C4956A',
    bgColor: '#F2E8D5',
    imageUrl: 'https://i.imgur.com/GJs0bJs.jpeg',
  ...
  },
  {
    ...
    bio: 'Reezal helps in basic design tasks while maintaining designs and brand identity.',
    canva: 'https://canva.link/xdah04b426x0esg',
    initials: 'AR',
    color: '#3D1F08',
    bgColor: '#C4956A',
    imageUrl: 'https://i.imgur.com/870JPnc.jpeg',
